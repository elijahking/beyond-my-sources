...
function SelectAll () {
  ...
  // 2. Set Partnered Content to 'Yes'
  const partneredFilter = document.getElementById("filter-partnered-content");
  if (partneredFilter) {
    partneredFilter.value = "t"; // 't' is the internal value for 'Yes'
  }
}
